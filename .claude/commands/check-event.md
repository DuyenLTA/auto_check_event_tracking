...
## 5. Publish artifact — bắt buộc, không phải tuỳ chọn

Tool chạy ở `127.0.0.1`, không có đường tới claude.ai, nên đây là việc duy nhất
chỉ Claude làm được. Lượt nào xong cũng publish, kể cả lượt 0 pass — người dùng
cần xem ảnh để biết nó hụt ở đâu.
